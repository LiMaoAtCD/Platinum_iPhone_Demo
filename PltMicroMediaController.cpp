...
const char*
PLT_MicroMediaController::ChooseServerIDFromTable(PLT_StringMap& table)
{
    printf("Select one of the following:\n");
...
const char*
PLT_MicroMediaController::ChooseRendererIDFromTable(PLT_StringMap& table)
{
    printf("Select one of the following:\n");
...
//对应获取DMS
void PLT_MicroMediaController::getDMS(){
    HandleCmd_getms();
}
...
//    iPhoneName = name;
//}
//const char* PLT_MicroMediaController::getiPhoneName() {
//    return iPhoneName;
//}
...
/*----------------------------------------------------------------------
 |   PLT_MicroMediaController::ChooseServerDevice
 +---------------------------------------------------------------------*/
PLT_DeviceDataReference
PLT_MicroMediaController::ChooseServerDevice(const NPT_Lock<PLT_DeviceMap>& deviceList)
{
    PLT_StringMap            namesTable;
    PLT_DeviceDataReference* result = NULL;
    NPT_String               chosenUUID;
    ...
    // ask user to choose
//    chosenUUID = ChooseIDFromTable(namesTable);
    chosenUUID = ChooseServerIDFromTable(namesTable);
...
/*----------------------------------------------------------------------
 |   PLT_MicroMediaController::ChooseRenderDevice
 +---------------------------------------------------------------------*/

PLT_DeviceDataReference
PLT_MicroMediaController::ChooseRendererDevice(const NPT_Lock<PLT_DeviceMap>& deviceList){
    PLT_StringMap            namesTable;
    PLT_DeviceDataReference* result = NULL;
    NPT_String               chosenUUID;
    NPT_AutoLock             lock(m_MediaServers);
